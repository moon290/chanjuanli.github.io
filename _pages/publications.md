...
*Yusen Liu, **Dayiheng Liu**\* (equal contribution) and Jiancheng Lv*  
...
3. **Revision in Continuous Space: Fine-Grained Control of Text Style Transfer**  
...
6. **Ancient-Modern Chinese Translation with a New Large Training Dataset**  
...
8. **Generating Style-specific Chinese Tang Poetry with a Simple Actor-Critic Model**  
...
11. **Method to Improve the Performance of Restricted Boltzmann Machines**  
